...
%             counters.n_traced;           % number of people traced at each time step
        ...
        methods
            % Class Constructor
            function [self] = VacAMR_IBM2(N, params, adj_set, VERBOSE, LOW_MEM)
...
%                 current_state = self.indiv_state(:,:,end);
                ...
                %RM need to also include whether person is vaccinated
                infect_force = (1 - ( ( 1-repmat(self.BETA,self.N,1) ).^nb_totals )) .* mask;
                %RM multiply by 1-vaccinated param? 
