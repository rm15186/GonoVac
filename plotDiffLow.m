...
%  
 ...
 days = [-500:4000];
    ...
    hold on;
        ...
        plot([0:n_Days],avg_vac_current1,'color',[255/255,128/255,0],'linewidth',1);
        plot([0:n_Days],avg_vac_current2,'linewidth',1,'color',[19/255,145/255,62/255]);
        plot([0:n_Days],avg_vac_current3,'color',[0.494,0.184,0.556],'linewidth',1);
    ...
    hold on;
        plot((0:n_Days),avg_cefta1,'color',[255/255,128/255,0],'linewidth',1);
        plot((0:n_Days),avg_cefta2,'color',[19/255,145/255,62/255],'linewidth',1);
        plot((0:n_Days),avg_cefta3,'color',[0.494,0.184,0.556],'linewidth',1);
        xlabel('Time (days)','fontsize',14,'Interpreter','latex');
   ...
   figure('name','comparison of vaccination doses');
    hold on;
        plot((0:n_Days),avg_vac_doses1,'color',[255/255,128/255,0],'linewidth',1);
        plot((0:n_Days),avg_vac_doses2,'color',[19/255,145/255,62/255],'linewidth',1);
        plot((0:n_Days),avg_vac_doses3,'color',[0.494,0.184,0.556],'linewidth',1);
        xlabel('Time (days)','fontsize',14,'Interpreter','latex');
