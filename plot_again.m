...
figure('name', 'Average Prevalence with interquartile range');
                ...
                shadedErrorBar([0:n_Days],plot_either,[i25e,i75e],'lineprops','k');
                shadedErrorBar([0:n_Days],plot_data(:,1),[i25(:,1),i75(:,1)],'lineprops','b');
                shadedErrorBar([0:n_Days],plot_data(:,2),[i25(:,2),i75(:,2)],'lineprops','r');
                legend('non-AMR','AMR');
                xlabel('Time (days)')
            ...
            % of the daily dosage of each drug
                ...
                %over the 2000 day burn in 
                 ...
                 figure('name','steady state then vaccine');
                    ...
                    plot(days,plot_change_both(:,1),'r');
                    plot(days,plot_change_both(:,2),'b');
                    xline(500);
