...
% (single model run)
%% script to run on blue crystal, quick just to make sure i can send and recieve data
...
% do i need to change the function?
    ...
    % (or can be referenced directly)
        ...
        %this wont do anything in BC because 
        ...
        % manual plots (examples)
            ...
            prev_data = 100*data.prevalence./N %want this to be the data bc sends back to me
